...
#
# 前置条件:
#   1. Phase 1 完成: checkpoints/qwen3-4b_sft_cot_p1/best/ 存在
...
# 前置检查
if [ ! -f "checkpoints/qwen3-4b_sft_cot_p1/best/meta.json" ]; then
    echo "ERROR: Phase 1 best checkpoint 不存在，请先运行 scripts/qwen3-4b_sft_cot_phase1.sh"
    exit 1
fi
...
python -m accelerate.commands.launch \
    ...
    --load-gates          checkpoints/qwen3-4b_sft_cot_p1/best \
