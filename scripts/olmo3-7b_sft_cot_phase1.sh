#!/usr/bin/env bash
# olmo3-7b_sft_cot_phase1.sh — OLMo3-7B CoT Curriculum Phase 1: News SFT
#
...
#
# 复现:
#   bash scripts/olmo3-7b_sft_cot_phase1.sh
#   CUDA_VISIBLE_DEVICES=2,3 NUM_GPUS=2 bash scripts/olmo3-7b_sft_cot_phase1.sh
set -euo pipefail
...
python -m accelerate.commands.launch \
    ...
    --ckpt-dir            checkpoints/olmo3-7b_sft_cot_p1 \
    --prompt-mode         cot \
    --epochs              5 \
    --batch-size          2 \
    --lr                  1e-3 \
    ...
    2>&1 | tee "logs/olmo3-7b_sft_cot_phase1.log"
