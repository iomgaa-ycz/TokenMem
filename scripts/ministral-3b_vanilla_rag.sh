#!/bin/bash
# ministral-3b — vanilla_rag baseline 评测
# 用法：
#   bash scripts/ministral-3b_vanilla_rag.sh                          # 默认 GPU 0，全量
#   CUDA_VISIBLE_DEVICES=2 bash scripts/ministral-3b_vanilla_rag.sh   # 指定 GPU
#   N_SAMPLES=10 bash scripts/ministral-3b_vanilla_rag.sh             # smoke test
set -euo pipefail
...
echo "=== ministral-3b / vanilla_rag 完成 ==="
